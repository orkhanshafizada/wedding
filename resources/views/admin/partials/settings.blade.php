...
<script>
// Theme Customizer Cookie Manager
(function() {
    const COOKIE_NAME = 'admin_theme_settings';
    ...
    function saveSettings() {
        const settings = {};
        document.querySelectorAll('.form-check-input[type="radio"]:checked').forEach(input => {
            settings[input.name] = input.value;
        });
        setCookie(COOKIE_NAME, settings, COOKIE_DAYS);
    }
