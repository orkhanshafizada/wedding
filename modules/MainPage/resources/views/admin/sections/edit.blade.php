...
@section('title', __('Edit Main Page Section'))

@section('content')
    <div class="page-content">
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-3">
                <h4 class="mb-sm-0">{{ __('Edit Main Page Section') }}</h4>
            ...
            <form action="{{ route('admin.main_page.sections.update', $section) }}" method="POST">
                @csrf
                @method('PUT')
