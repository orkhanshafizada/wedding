    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-3">
                <h4 class="mb-sm-0">{{ __('Form Labels') }} - {{ $menu->title }}</h4>
                <div>
                    <a href="{{ route('admin.form.index', $menu) }}" class="btn btn-secondary me-2">
                        <i class="ri-arrow-left-line align-bottom me-1"></i> {{ __('Back to Form') }}
                    </a>
                    <a href="{{ route('admin.form.label.create', $menu) }}" class="btn btn-primary">
                        <i class="ri-add-line me-1"></i> {{ __('New Label') }}
                    </a>
                </div>
            </div>
