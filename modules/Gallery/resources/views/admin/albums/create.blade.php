    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="mb-0">{{ __('Add New Album') }} - {{ $menu->name }}</h4>
            ...
            <form action="{{ route('admin.gallery.store', $menu) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="show_album" id="show_album" value="1" checked>
