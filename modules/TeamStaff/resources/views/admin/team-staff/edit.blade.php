...
@section('title', 'Team Staff Redaktə Et')
        ...
        <div class="container-fluid">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-semibold">Team Staff Redaktə Et - {{ $menu->name }}</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.team-staff.update', [$menu, $teamStaff]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
